...
feature "Add/Remove social profiles" do
  ...
  let(:fb_message) { "Successfully authenticated from Facebook account" }
  let(:google_message) { "Successfully authenticated from Google Oauth2 account" }
  ...
  context "when social account is verified" do
    ...
    context "when provider is Facebook" do
      ...
      scenario "user adds social profile" do
        ...
        click_link "Facebook"
        expect(page).to have_content(fb_message)
    ...
    context "when provider is Google" do
      ...
      scenario "user adds social profile" do
        ...
        click_link "Google"
        expect(page).to have_content(google_message)
        expect(page).to have_content("Linked social networks")
  ...
  context "when social account is not verified" do
    ...
    context "when provider is Facebook" do
      ...
      scenario "user not able to add social profile" do
        ...
        click_link "Facebook"
        expect(page).to have_content("Sorry, but yours Facebook failed verification. Seems like yours Facebook account hasn't been verified.")
        expect(page).not_to have_content("Linked social networks")
    ...
    context "when provider is Google" do
      ...
      scenario "user not able to add social profile" do
        ...
        click_link "Google"
        expect(page).to have_content("Sorry, but yours Google Oauth2 failed verification. Seems like yours Google Oauth2 account hasn't been verified.")
        expect(page).not_to have_content("Linked social networks")
